"""
Django settings for accountmanager1 project.
...
SECRET_KEY = 'nxw^*jovru6bydyt2@kx&ck((wt6yg5o^kk7p^bbwtaf_^t^6q'
...
ROOT_URLCONF = 'accountmanager1.urls'
...
WSGI_APPLICATION = 'accountmanager1.wsgi.application'
